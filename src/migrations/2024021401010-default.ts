...
export class Default2024021401010 implements MigrationInterface {
    name = 'Default2024021401010'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "titles" ("title_id" SERIAL NOT NULL, "name" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_b89ec0288561afa4dba62b19ebd" PRIMARY KEY ("title_id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "users" ("user_id" SERIAL NOT NULL, "name" character varying NOT NULL, "email" character varying NOT NULL, "password" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "title_id" integer, "permissionUser_id" integer, "permission_id" integer, "squad_id" integer, CONSTRAINT "PK_96aac72f1574b88752e9fb00089" PRIMARY KEY ("user_id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "FK_4ce68a5a8f867dfff4114951c15" FOREIGN KEY ("title_id") REFERENCES "titles"("title_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
